package ma.enset.projet_innovation;
...
import ma.enset.projet_innovation.entities.RendezVous;
import ma.enset.projet_innovation.enums.Status;
import ma.enset.projet_innovation.repositories.ConsultationRepository;
import ma.enset.projet_innovation.repositories.DossierMedicalRepository;
import ma.enset.projet_innovation.repositories.MedecinRepository;
import ma.enset.projet_innovation.repositories.PatientRepository;
import ma.enset.projet_innovation.repositories.RendezVousRepository;
...
public class ProjetDInnovationApplication {

	public static void main(String[] args) {
		SpringApplication.run(ProjetDInnovationApplication.class, args);
	}
